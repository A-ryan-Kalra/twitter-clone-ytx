...
function Feed() {
  ...
  return (
    <div
      className="text-white flex-grow  border-l border-r border-gray-700 max-w-2xl sm:ml-[73px]  xl:min-w-[670px]
     xl:ml-[370px]"
    >
      <div
        className="text-[#d9d9d9] flex items-center bg-transparent/80 sm:justify-between py-2 px-3
