...
function Sidebar() {
  return (
    <div className=" hidden sm:flex flex-col items-center xl:items-start  xl:w-[340px]   p-2 fixed h-full  ">
      ...
      <div className="space-y-2.5 mt-4 mb-3 xl:ml-24">
      ...
      <button
        className="hidden xl:ml-24 xl:inline ml-auto rounded-full text-lg font-bold shadow-md hover:bg-[#1a8cd8]
       w-48 h-[46px] bg-[#1d9bf0] text-white"
      >
        Tweet
      </button>
